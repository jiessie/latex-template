...
%
% Improvement:
% Jie Cao (https://github.com/jiessie/latex-template)
%
% Important note:
...
\begin{center}
\HRule \\[0.4cm]
{\Huge \bfseries Weekly Report \\[0.5cm] \Large AMR}\\[0.4cm] % Degree
\HRule \\[1.5cm]
\end{center}
}
\author{\Huge Jie Cao \\ \\ \LARGE jcao@cs.utah.edu \\[2cm]} % Your name and email address
\date{08/29/2016-09/05/2016} % date range
\maketitle
